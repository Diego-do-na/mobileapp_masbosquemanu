...
const styles = StyleSheet.create({
    ...
    cancelButton:  { backgroundColor: COLORS.SURFACE, borderWidth: 1, borderColor: COLORS.BORDER_SOFT },
    confirmButton: { backgroundColor: COLORS.SUCCESS },

    modalButtonText:   { color: COLORS.BACKGROUND, fontSize: 16, fontWeight: "600" },
    cancelButtonText:  { color: COLORS.TEXT_MEDIUM },
    ...
    newButton:    { backgroundColor: COLORS.INFO },
    deleteButton: { backgroundColor: COLORS.DANGER },

    previewButtonText: { color: COLORS.BACKGROUND, fontSize: 14, fontWeight: "600" },
